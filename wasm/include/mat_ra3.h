...
extern void eulerm313(double euler[3], double rmat[3][3]);
extern void eulerm323(double euler[3], double rmat[3][3]);
extern void eulerm123(double euler[3], double rmat[3][3]);
extern void eulerm213(double euler[3], double rmat[3][3]);
extern void mateuler321(double rmat[3][3], double euler[3]);
extern void mateuler313(double rmat[3][3], double euler[3]);
extern void mateuler323(double rmat[3][3], double euler[3]);
extern void mateuler123(double rmat[3][3], double euler[3]);
extern void mateuler213(double rmat[3][3], double euler[3]);
